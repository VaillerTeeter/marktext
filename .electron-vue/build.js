...
function doTranslate() {
  ...
  const { markTextAsarTranslate } = require('../tools/translator/marktext_asar_translate')
  console.log(process.env['lang'])
  const longRootPath = path.resolve(__dirname, '../tools/translator')
