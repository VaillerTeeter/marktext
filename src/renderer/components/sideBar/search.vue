    ...
    >
      <div class="search-wrapper">
        ...
        <div class="controls">
          ...
          <span
            :title="$t('sidebar.selectWholeWord')"
            class="is-whole-word"
      ...
      <div class="search-message-section" v-if="showNoResultFoundMessage">{{$t('sidebar.noResultsFound')}}</div>
      ...
      >
        ...
        >
          {{$t('sidebar.cancel')}} <i class="el-icon-video-pause"></i>
        </el-button>
      </div>
