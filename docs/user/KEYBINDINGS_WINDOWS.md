...
本文列出 MarkText 在 Windows 上的默认快捷键

如果你想自定义快捷键（通过 `keybindings.json` 覆盖默认值），请先阅读 [快捷键（总览）](KEYBINDINGS.md)

> 说明（Windows 特别注意）：在 Windows 上 `Ctrl+Alt` 通常等同于 `AltGr`，会影响一些非美式键盘布局输入特殊字符
> 因此部分功能在 Windows 默认不会设置快捷键（例如标题 1~6），以避免与输入法/键盘布局冲突
...
| `edit.duplicate`         | <kbd>Ctrl</kbd>+<kbd>Alt</kbd>+<kbd>D</kbd>   | 复制当前段落                                    |
...
| Id                          | 默认快捷键                                     | 说明                                     |
| --------------------------- | --------------------------------------------- | ---------------------------------------- |
| `paragraph.heading-1`       | -                                             | 将当前行设为标题 1                         |
| `paragraph.heading-2`       | -                                             | 将当前行设为标题 2                         |
| `paragraph.heading-3`       | -                                             | 将当前行设为标题 3                         |
| `paragraph.heading-4`       | -                                             | 将当前行设为标题 4                         |
| `paragraph.heading-5`       | -                                             | 将当前行设为标题 5                         |
| `paragraph.heading-6`       | -                                             | 将当前行设为标题 6                         |
...
| `paragraph.loose-list-item` | <kbd>Ctrl</kbd>+<kbd>Alt</kbd>+<kbd>L</kbd>   | 将列表项转换为松散列表项                   |
| `paragraph.paragraph`       | <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>0</kbd> | 将标题转换为普通段落                       |
| `paragraph.horizontal-line` | <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>U</kbd> | 插入分割线                                 |
| `paragraph.front-matter`    | <kbd>Ctrl</kbd>+<kbd>Alt</kbd>+<kbd>Y</kbd>   | 插入 YAML Front Matter 块                  |
...
| `format.inline-code`  | <kbd>Ctrl</kbd>+<kbd>`</kbd>                  | 行内代码                                        |
